    ...
    addToCartMutation.mutate(
      ...
      },
      {
        onSuccess: (data) => {
          ...
          queryClients.invalidateQueries({ queryKey: ['purchases', { status: purchasesStatus.inCart }] })
        }
      }
    )
  }
        ...
        <div className='bg-white p-4 shadow'>
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='flex h-12 items-center justify-center rounded-sm border border-orange bg-orange/10 px-5 capitalize text-orange shadow-sm hover:bg-orange/5'>
                  <button
                    onClick={addToCart}
                ...
                <button
                  className='captialize ml-4 flex h-12 min-w-[5rem] items-center justify-center rounded-sm bg-orange px-5 text-white shadow-sm outline-none hover:bg-orange/90'
